            ...
            .map(section => (
              <div key={section.id}>
                {typeof section.content === 'string' ? (
                  // Code/text content - render as preformatted
                  <pre className="bg-slate-900 p-4 rounded-lg text-sm text-slate-200 overflow-x-auto whitespace-pre font-mono">
                    {section.content}
                  </pre>
                ) : (
                  // Term/definition array content
